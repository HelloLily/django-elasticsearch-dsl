...
class ActionBuffer(object):
    ...
    def add_model_actions(self, model, action='index'):
        ...
        for related_model in self._registry.get_related_models(model.__class__):
            for doc in self._registry.get_documents(related_model):
                doc_instance = doc()
                ...
                if related:
                    ...
                    # not delete.
                    self.add_doc_actions(doc, related, action='index')
